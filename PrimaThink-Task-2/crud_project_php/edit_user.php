...
<nav class="navbar navbar-expand-lg navbar-light bg-white p-4">
    ...
    <?php
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <h2 style="text-align:center" class="pb-2">EDIT USER</h2>
            <div class="form-group">
                <label for="exampleInputEmail1">Name</label>
                <input type="text" class="form-control" id="exampleInputEmail1" value=<?php echo $user_name; ?> name = "user_name">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="exampleInputPassword1" name = "user_password" value=<?php echo $user_password; ?>>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Image</label>
                <input type="file" class="form-control" id="exampleInputPassword1" name = "user_image" value=<?php echo $user_name; ?>>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Details</label>
                <input type="text" class="form-control" id="exampleInputPassword1" name = "user_details" value=<?php echo $user_details; ?>/>
            </div>
    ...
    if(isset($_POST['insert-btn'])){
        ...
        $edit_user_details = $_POST['user_details'];

        if(empty($edit_image)){
            $edit_image = $user_image;
        }

        $update = "UPDATE user SET user_name='$edit_user_name', user_email='$edit_user_email',
        user_password='$edit_user_password',user_image='$edit_image',user_details='$edit_user_details' WHERE user_id = '$edit_id'  ";

        $run_insert = mysqli_query($conn,$update);

        if($run_insert === true){
            echo"data sent";
            move_uploaded_file($edit_tmp_name,"upload/$edit_image");
        }
        else{
